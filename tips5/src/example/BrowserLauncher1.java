...
public class BrowserLauncher1 extends JPanel {
    // private static String MYSITE = "http://terai.xrea.jp/";
    private static String MYSITE = "https://github.com/IwaoWatanabe/java-swing-tips/wiki/";
    private final JTextArea textArea = new JTextArea();
    public BrowserLauncher1() {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new BrowserLauncher1());
        frame.pack();
