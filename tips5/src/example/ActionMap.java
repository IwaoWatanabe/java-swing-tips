...
public class ActionMap extends JPanel{
    private final JTextField pf1 = new JTextField(25);
    private final JTextField pf2;
    public ActionMap() {
        super(new BorderLayout());

        javax.swing.ActionMap am = pf1.getActionMap();
                ...
                EventQueue.invokeLater(new Runnable() {
                    @Override public void run() {
                        ...
                        JOptionPane.showMessageDialog(
                            ActionMap.this, "paste is disabled", "title",
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new ActionMap());
        frame.pack();
