...
public class DnDList extends JPanel{
    public DnDList() {
        super(new BorderLayout());
        DnDList1 list1 = new DnDList1();
...
class DnDList1 extends JList implements DragGestureListener, DragSourceListener, Transferable {
