...
public class LineNumber extends JPanel {
    ...
    public LineNumber() {
        ...
        scroll.setRowHeaderView(new LineNumberView2(edit));
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new LineNumber());
        frame.pack();
...
class LineNumberView2 extends JComponent {
    ...
    public LineNumberView2(JTextPane textArea) {
        text = textArea;
