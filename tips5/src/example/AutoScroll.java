...
class AutoScroll extends JPanel {
    public AutoScroll() {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new AutoScroll());
        frame.pack();
...
class DragMoverListener extends MouseAdapter implements MouseMotionListener, HierarchyListener{
