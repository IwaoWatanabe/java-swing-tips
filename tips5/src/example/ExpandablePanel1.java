...
public class ExpandablePanel1 extends JPanel{
    ...
    public ExpandablePanel1() {
        super(new BorderLayout());
        JPanel panel = new JPanel(new BorderLayout());
        final java.util.List<ExpansionPanel2> panelList = makeList();
        ExpansionListener rl = new ExpansionListener() {
            public void expansionStateChanged(ExpansionEvent e) {
                initComps(panelList, e);
            }
        };
        for(ExpansionPanel2 exp: panelList) {
            northBox.add(exp);
    ...
    public void initComps(java.util.List<ExpansionPanel2> list, ExpansionEvent e) {
        setVisible(false);
        centerBox.removeAll();
        northBox.removeAll();
        southBox.removeAll();
        ExpansionPanel2 es = (ExpansionPanel2) e.getSource();
        boolean flag = false;
        for(ExpansionPanel2 exp: list) {
    ...
    private java.util.List<ExpansionPanel2> makeList() {
        return Arrays.<ExpansionPanel2>asList(
            new ExpansionPanel2("Panel1") {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new ExpandablePanel1());
        frame.pack();
...
abstract class ExpansionPanel2 extends JPanel {
    ...
    public ExpansionPanel2(String title_) {
        super(new BorderLayout());
        title = title_;
