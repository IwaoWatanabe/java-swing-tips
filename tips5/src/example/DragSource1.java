...
public class DragSource1 extends JPanel {
    private final JLabel label = new JLabel();
    private final DragSource dragSource = DragSource.getDefaultDragSource();

    private final URL u1 = DragSource1.class.getResource("i03-04.gif");
    private final URL u2 = DragSource1.class.getResource("i03-10.gif");
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new DragSource1());
        frame.pack();
