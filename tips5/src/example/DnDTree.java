...
public class DnDTree extends JPanel {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new DnDTree());
        frame.pack();
...
class DnDTree1 extends JTree implements DragSourceListener, DropTargetListener, DragGestureListener {
