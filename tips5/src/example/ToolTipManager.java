...
public class ToolTipManager extends JPanel{
    ...
    public ToolTipManager() {
        ...
        javax.swing.ToolTipManager.sharedInstance().unregisterComponent(field);
    ...
    private JComponent makeToolPanel() {
        ...
        ActionListener al = new ActionListener() {
            @Override public void actionPerformed(ActionEvent e) {
                javax.swing.ToolTipManager.sharedInstance().setEnabled(onRadio.isSelected());
            }
        };
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new ToolTipManager());
        frame.pack();
