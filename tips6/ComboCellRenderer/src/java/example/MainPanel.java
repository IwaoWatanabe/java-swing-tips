...
<<<<<<< HEAD:ComboCellRenderer/src/java/example/MainPanel.java
...
=======
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new ComboCellRenderer1());
        frame.pack();
...
class ComboCellRenderer extends JComboBox implements TableCellRenderer {
    ...
    public ComboCellRenderer() {
        super();
        setEditable(true);
>>>>>>> gradle-build:tips6/ComboCellRenderer/src/java/example/MainPanel.java
