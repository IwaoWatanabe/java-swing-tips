...
public class FileHistory extends JPanel{
    ...
    public FileHistory(final JFrame frame) {
...
//     }
    ...
    protected class VersionAction extends AbstractAction{
        ...
        @Override public void actionPerformed(ActionEvent evt) {
            ...
            JOptionPane.showMessageDialog(FileHistory.this, obj, APP_NAME,
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new FileHistory(frame));
        frame.pack();
