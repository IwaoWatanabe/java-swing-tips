...
public class SwingWorker1 extends JPanel {
    ...
    class RunAction extends AbstractAction{
        ...
        @Override public void actionPerformed(ActionEvent evt) {
            ...
            worker.addPropertyChangeListener(new ProgressListener2(bar));
            worker.execute();
        }
    }
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new SwingWorker1());
        frame.pack();
...
class ProgressListener2 implements PropertyChangeListener {
    private final JProgressBar progressBar;
    ProgressListener2(JProgressBar progressBar) {
