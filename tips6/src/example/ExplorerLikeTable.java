...
public class ExplorerLikeTable extends JPanel {
    private final TestModel model = new TestModel();
    private final JTable table = new JTable(model);
    public ExplorerLikeTable() {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new ExplorerLikeTable());
        frame.pack();
        frame.setLocationRelativeTo(null);
        frame.setVisible(true);
    }

static class TestRenderer extends Box implements TableCellRenderer {
