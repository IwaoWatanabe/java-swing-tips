...
public class TableRowHeader extends JPanel {
    private final DefaultListModel listModel = new DefaultListModel();
    private final TestModel5 model = new TestModel5(listModel);
    private final JTable table = new JTable(model);
    public TableRowHeader() {
        super(new BorderLayout());
        model.addTest(new Test5("Name 1", "comment"));
        model.addTest(new Test5("Name 2", "test"));
        model.addTest(new Test5("Name d", ""));
        model.addTest(new Test5("Name c", "test cc"));
        model.addTest(new Test5("Name b", "test bb"));
        model.addTest(new Test5("Name a", ""));
        model.addTest(new Test5("Name 0", "test aa"));
        model.addTest(new Test5("Name 0", ""));
    ...
    private void testCreateActionPerformed(ActionEvent e) {
        model.addTest(new Test5("add row", ""));
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new TableRowHeader());
        frame.pack();
