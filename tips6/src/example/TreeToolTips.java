...
public class TreeToolTips extends JPanel {
    public TreeToolTips() {
        ...
        javax.swing.ToolTipManager.sharedInstance().registerComponent(tree1);

        JTree tree2 = new JTree();
        tree2.setCellRenderer(new ToolTipTreeCellRenderer(tree2.getCellRenderer()));
        //tree2.setToolTipText("dummy");
        javax.swing.ToolTipManager.sharedInstance().registerComponent(tree2);
...
//     }
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new TreeToolTips());
        frame.pack();
