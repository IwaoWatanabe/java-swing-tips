...
public class PasswordView1 extends JPanel {
    public PasswordView1() {
    ...
    public static void createAndShowGUI() {
        ...
        frame.getContentPane().add(new PasswordView1());
        frame.pack();
...
class MyPasswordFieldUI extends BasicPasswordFieldUI {
    ...
    @Override public javax.swing.text.View create(Element elem) {
...
//             return x + fm.charWidth(c);
    ...
    static StarIcon1 icon = new StarIcon1();
}
